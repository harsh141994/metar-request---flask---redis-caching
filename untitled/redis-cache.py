...
obj = SimpleCache()
#s.store("harsh", "varshney", 15);
r = requests.get('http://tgftp.nws.noaa.gov/data/observations/metar/stations/AABS.TXT');
#print r.text;
...
obj.store_json("AABS", js, 15)

print obj.get_json("AABS")
